...
export function CommunityCard({ entry, onOpen, onReact, onSave }) {
  ...
  return (
    <article className="community-card">
      ...
      <div className="community-card__content">
        <button
          className="community-card__open"
          type="button"
        ...
        <div className="community-card__actions">
          ...
          <button
            ...
            onClick={() => onOpen?.(entry)}
          >
            <span>{entry.reactions_total ?? 0} reacciones</span>
            <span>{entry.comments_count ?? 0} comentarios</span>
          </button>
        </div>
      </div>
    </article>
