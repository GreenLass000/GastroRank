...
export function ComunidadScreen({ onOpenEntity, onOpenSearch }) {
  ...
  return (
    <section className="screen" aria-label="Pantalla de comunidad">
      <div className="community-screen__subtabs">
        <button
          className={`pill-button${tab === 'amigos' ? ' community-screen__subtab--active' : ''}`}
          type="button"
          onClick={() => {
            setTab('amigos')
            setPage(1)
        ...
        <button
          className={`pill-button${tab === 'explorar' ? ' community-screen__subtab--active' : ''}`}
          type="button"
          onClick={() => {
            setTab('explorar')
            setPage(1)
